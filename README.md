...
3)	Search Book by Title – The user can search a book using the title.
4)	View Books by Category – The user can view books under a specific category.
5)	View Books by Price Range – The user can view books specified by a price range. 
